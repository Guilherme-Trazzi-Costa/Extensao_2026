...
if __name__ == "__main__":
    ...
    st.markdown(
        "Esta é a área protegida. No painel de verdade, é aqui que entram "
        "as abas **Financeiro** e **Metas**.\n\n"
        "Para plugar no painel existente, troque este bloco pelo conteúdo do "
        "`projeto_extensao.py` — ou importe daqui:\n"
    )
    st.code(
        "from tela_login import exigir_login, barra_usuario\n\n"
